...
require (
	...
	github.com/enfein/mieru/v3 v3.6.0 // indirect
...
replace (
	...
	github.com/metacubex/mihomo => github.com/snakem982/mihomo v1.0.8-moshen
	github.com/sagernet/sing => github.com/metacubex/sing v0.0.0-20241105005934-13bf5e941908
)
